...
<div class="col-sm-6">
	<div class="panel panel-info">
		<div class="panel-heading" align="center">
			<h4>Create Charts Of Account</h4>
		</div>
			...
			<table class="table table-responsive" align="center" cellpadding="5" cellspacing="5">
				...
				?>
						<tr>
							...
							<td><?= date('D, d-M-Y', strtotime($row['budget_category_add_date'])); ?></td>
							<td><a href="chartsofaccount.php?budget_category_del_id=<?= $row['budget_category_id'] ?>" class="text-danger"><span class="glyphicon glyphicon-remove"></span></a> |
								<a href="chartsofaccount.php?budget_category_edit_id=<?= $row['budget_category_id'] ?>" class="text-success"><span class="glyphicon glyphicon-edit"></span></a>
							</td>
