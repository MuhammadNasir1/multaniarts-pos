                        ...
                        <div class="row form-group">
                            <div class="col-6 row">
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input type="text" placeholder="Gate Pass" value="" autocomplete="off" class="form-control " name="d_lat_no" id="d_lat_no">
                                </div>
                                <div class="col-md-3  mt-3">
                                    <label>Program</label>
                                ...
                                <div class="col-md-3 mt-3">
                                    ...
                                    <input type="text" placeholder="Gate Pass" value="" autocomplete="off" class="form-control " name="embroidery" id="embroidery">
                                </div>
                            </div>
